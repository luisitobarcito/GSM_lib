function [G, p_cs, p_gain, Ecs_gain, Ec_gain] = flexibleNormalization(X, model, whiten, matchvar)
%FLEXIBLENORMALIZATION
...
%    p_gain - normalization gain G = X * p_gain
%    Ecs_gain - gain for conditional expectation of G given X and cs dependent
%    model
%    Ec_gain - gain for conditional expectation of G given X and cs independent.
% 
%
% See also: CANONICALNORMALIZATION,  FLEXIBLELOGLIKELIHOOD
